...
class Ui_diag_sshauth(object):
    ...
    def retranslateUi(self, diag_sshauth):
        ...
        self.lbl_username.setText(_translate("diag_sshauth", "SSH user name:"))
        self.lbl_password.setText(_translate("diag_sshauth", "SSH password:"))
        self.cbx_save_password.setToolTip(_translate("diag_sshauth", "Save user name and password in secure password storage."))
        self.cbx_save_password.setText(_translate("diag_sshauth", "Save user name and password"))
        self.lbl_info.setText(_translate("diag_sshauth", "Default SSH user is \"pi\". The device password is on the RevPi housing sticker."))
