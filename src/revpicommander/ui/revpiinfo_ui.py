...
class Ui_diag_revpiinfo(object):
    def setupUi(self, diag_revpiinfo):
        ...
        self.lbl_link.setText("<html><head/><body><p><a href=\"https://revpimodio2.readthedocs.io/en/latest/\"><span style=\" text-decoration: underline; color:#0000ff;\">https://revpimodio2.readthedocs.io/en/latest/</span></a></p></body></html>")
    ...
    def retranslateUi(self, diag_revpiinfo):
        ...
        self.lbl_head.setText(_translate("diag_revpiinfo", "RevPi Commander (Python/PLC)"))
