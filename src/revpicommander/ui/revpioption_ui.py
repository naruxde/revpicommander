...
class Ui_diag_options(object):
    ...
    def retranslateUi(self, diag_options):
        ...
        self.gb_plc.setTitle(_translate("diag_options", "PLC Start/Stop Behavior"))
        self.lbl_replace_io.setText(_translate("diag_options", "Replace I/O file:"))
        self.cbx_zeroonerror.setText(_translate("diag_options", "after exceptions or errors"))
        ...
        self.cbb_reset_driver_action.setItemText(1, _translate("diag_options", "Restart after PiCtory changes"))
        ...
        self.lbl_plc_zero.setText(_translate("diag_options", "Set process image to NULL if the program terminates"))
        self.cbb_replace_io.setItemText(0, _translate("diag_options", "Do not replace I/O file"))
        ...
        self.cbb_replace_io.setItemText(3, _translate("diag_options", "Use custom path and file name"))
        self.cbx_zeroonexit.setText(_translate("diag_options", "without errors"))
        ...
        self.lbl_lbl_reset_driver_action.setText(_translate("diag_options", "PLC program behavior after PiCtory driver reset"))
        ...
        self.cbx_plcserver.setText(_translate("diag_options", "Start piControl server"))
        self.lbl_server_status.setText(_translate("diag_options", "status"))
        self.lbl_lbl_server_status.setText(_translate("diag_options", "piControl server:"))
        self.lbl_mqtt_status.setText(_translate("diag_options", "status"))
        self.lbl_lbl_mqtt_status.setText(_translate("diag_options", "MQTT publish service:"))
        self.btn_mqtt.setText(_translate("diag_options", "Settings"))
        self.btn_aclxmlrpc.setText(_translate("diag_options", "Edit ACL"))
        self.cbx_xmlrpc.setText(_translate("diag_options", "Activate XML-RPC for RevPi Commander"))
