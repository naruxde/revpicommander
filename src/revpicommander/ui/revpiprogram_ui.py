...
class Ui_diag_program(object):
    ...
    def retranslateUi(self, diag_program):
        ...
        self.lbl_plcarguments.setText(_translate("diag_program", "Arguments:"))
        self.lbl_plcprogram_watchdog.setText(_translate("diag_program", "Software watchdog (0 = disabled):"))
        self.cbx_plcworkdir_set_uid.setText(_translate("diag_program", "Set write permissions for PLC program working directory"))
        self.lbl_plcprogram.setText(_translate("diag_program", "Python PLC start program:"))
        self.sbx_plcprogram_watchdog.setSuffix(_translate("diag_program", " s"))
        self.cb_transfair.setTitle(_translate("diag_program", "Transfer PLC program"))
        ...
        self.lbl_format.setText(_translate("diag_program", "Transfer format:"))
        self.cbx_pictory.setText(_translate("diag_program", "Include PiCtory configuration"))
        self.cbx_clear.setText(_translate("diag_program", "Remove all files on RevPi before upload"))
        ...
        self.lbl_pictory.setText(_translate("diag_program", "PiCtory configuration"))
        self.lbl_procimg.setText(_translate("diag_program", "Process image from piControl"))
