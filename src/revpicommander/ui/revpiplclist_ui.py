...
class Ui_diag_connections(object):
    def setupUi(self, diag_connections):
        ...
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.lbl_port)
        ...
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.sbx_port)
        self.lbl_timeout = QtWidgets.QLabel(self.tab_connection)
        self.lbl_timeout.setObjectName("lbl_timeout")
        self.formLayout_2.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.lbl_timeout)
        ...
        self.formLayout_2.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.sbx_timeout)
        self.lbl_folder = QtWidgets.QLabel(self.tab_connection)
        self.lbl_folder.setObjectName("lbl_folder")
        self.formLayout_2.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.lbl_folder)
        ...
        self.formLayout_2.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.cbb_folder)
    ...
    def retranslateUi(self, diag_connections):
        ...
        diag_connections.setWindowTitle(_translate("diag_connections", "RevPi Connections"))
        self.lbl_name.setText(_translate("diag_connections", "Display name:"))
        self.lbl_address.setText(_translate("diag_connections", "Address (DNS/IP/Socket):"))
        ...
        self.sbx_timeout.setSuffix(_translate("diag_connections", " s"))
        self.lbl_folder.setText(_translate("diag_connections", "Subfolder:"))
