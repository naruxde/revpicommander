...
class Ui_diag_simulator(object):
    ...
    def retranslateUi(self, diag_simulator):
        ...
        self.rb_restart_zero.setText(_translate("diag_simulator", "Reset all values to NULL"))
        self.gb_info.setTitle(_translate("diag_simulator", "RevPiModIO Integration"))
        self.lbl_info.setText(_translate("diag_simulator", "To use this simulator, call RevPiModIO with the following additional parameters:"))
        ...
        self.btn_start_nochange.setText(_translate("diag_simulator", "Start without changing the current process image"))
