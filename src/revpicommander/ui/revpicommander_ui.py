...
class Ui_win_revpicommander(object):
    ...
    def retranslateUi(self, win_revpicommander):
        ...
        self.act_search.setText(_translate("win_revpicommander", "&Search RevPi..."))
        self.act_quit.setText(_translate("win_revpicommander", "&Quit"))
        self.act_webpage.setText(_translate("win_revpicommander", "Visit &website"))
        ...
        self.act_pictory.setText(_translate("win_revpicommander", "PiCtory configuration"))
