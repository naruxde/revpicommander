...
class Ui_win_revpilogfile(object):
    ...
    def retranslateUi(self, win_revpilogfile):
        ...
        win_revpilogfile.setWindowTitle(_translate("win_revpilogfile", "RevPi Python PLC Log Files"))
        self.cbx_stay_on_top.setText(_translate("win_revpilogfile", "Stay on top of all windows"))
        self.cbx_wrap.setText(_translate("win_revpilogfile", "Line wrap"))
        self.lbl_daemon.setText(_translate("win_revpilogfile", "RevPiPyLoad Log File"))
        ...
        self.lbl_app.setText(_translate("win_revpilogfile", "Python PLC Program Log File"))
