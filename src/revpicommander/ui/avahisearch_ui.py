...
class Ui_diag_search(object):
    ...
    def retranslateUi(self, diag_search):
        ...
        diag_search.setWindowTitle(_translate("diag_search", "RevPi device search"))
        self.lbl_search.setText(_translate("diag_search", "Searching for RevPi devices on the network"))
        ...
        item.setText(_translate("diag_search", "ZeroConf name"))
        item = self.tb_revpi.horizontalHeaderItem(1)
        item.setText(_translate("diag_search", "IP address"))
        self.btn_connect.setText(_translate("diag_search", "&Connect to RevPi"))
        ...
        self.act_connect_ssh.setToolTip(_translate("diag_search", "Connect via an encrypted SSH tunnel."))
        self.act_connect_xmlrpc.setText(_translate("diag_search", "Connect via XML-RPC"))
        self.act_connect_xmlrpc.setToolTip(_translate("diag_search", "Enable these connections on RevPi."))
        self.act_connect.setText(_translate("diag_search", "Connect"))
        self.act_connect.setToolTip(_translate("diag_search", "Connect to RevPi"))
