...
class Ui_wid_debugcontrol(object):
    ...
    def retranslateUi(self, wid_debugcontrol):
        ...
        self.gb_devices.setTitle(_translate("wid_debugcontrol", "RevPi Devices"))
        self.cbx_stay_on_top.setText(_translate("wid_debugcontrol", "Keep window on top"))
        self.gb_control.setTitle(_translate("wid_debugcontrol", "I/O Control"))
        self.btn_read_io.setToolTip(_translate("wid_debugcontrol", "Read all I/O values and discard local changes (F4).\n"
"\n"
"Hold this button to refresh the I/Os every 200 ms."))
        self.btn_read_io.setText(_translate("wid_debugcontrol", "Read &all I/O values"))
        self.btn_refresh_io.setToolTip(_translate("wid_debugcontrol", "Refresh all I/O values that have not been modified locally (F5).\n"
"\n"
"Hold this button to refresh the I/Os every 200 ms."))
        self.btn_refresh_io.setText(_translate("wid_debugcontrol", "&Refresh unchanged I/Os"))
        self.btn_write_o.setToolTip(_translate("wid_debugcontrol", "Write locally modified output values to process image (F6)."))
        ...
        self.cbx_write.setText(_translate("wid_debugcontrol", "Write outputs"))
